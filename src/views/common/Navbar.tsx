...
export const Navbar = () => {
  ...
  return (
    <div className="h-12 sm:h-14 z-20">
      <div className="fixed top-0 w-screen h-12 sm:h-14 border-b border-gray-300 bg-blue-100 padding-20px">
        <Layout className="flex w-full h-full items-center">
          ...
          <div>
            <button className="text-2xl font-bold text-white bg-blue-600 rounded-full px-12 py-4 " onClick={handleClickToRegister}>
              Register Now
            </button>
          </div>
        </Layout>
